...
ACCOUNT_CREATE_URL = "http://www.wow-mania.com/register";
ACCOUNT_MESSAGE_BODY_NO_READ_URL = "http://ww.wow-mania.com/support";
ACCOUNT_MESSAGE_BODY_URL = "http://ww.wow-mania.com";
ACCOUNT_MESSAGE_BUTTON_READ = "Mark as read";
ACCOUNT_MESSAGE_HEADERS_URL = "http://ww.wow-mania.com";
ACCOUNT_MESSAGE_READ_URL = "http://ww.wow-mania.com";
...
AUTH_BANNED_URL = "http://www.wow-mania.com/rules";
...
AUTH_DB_BUSY_URL = "http://ww.wow-mania.com/status";
...
AUTH_NO_TIME_URL = "http://ww.wow-mania.com/connect";
...
AUTH_PARENTAL_CONTROL_URL = "http://ww.wow-mania.com";
...
AUTH_SUSPENDED_URL = "http://ww.wow-mania.com/terms";
...
BLIZZ_DISCLAIMER = "Copyright 2015-2016  WoW-Mania Private Servers. All Rights Reserved.";
BLOCK = "BLOCK %.2f";
...
INT = "INT";
LATEST_AGREEMENTS_URL = "http://www.wow-mania.com/rules";
LATEST_EULA_URL = "http://www.wow-mania.com/terms";
LATEST_TERMINATION_WITHOUT_NOTICE_URL = "http://www.wow-mania.com/rules";
LATEST_TOS_URL = "http://www.wow-mania.com/rules";
...
LOGIN_AUTH_OUTAGE = "<html><body><p align=\"CENTER\">The login server is currently busy. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.wow-mania.com/status\">http://www.wow-mania.com/status</a></p></body></html>";
LOGIN_BADVERSION = "<html><body><p align=\"CENTER\">Unable to validate game version.  This may be caused by file corruption or the interference of another program.  Please visit <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a> for more information and possible solutions to this issue.</p></body></html>";
LOGIN_BAD_SERVER_PROOF = "<html><body><p align=\"CENTER\">You are connecting to an invalid game server. Please contact Technical Support for assistance at: <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a></p></body></html>";
LOGIN_BAD_SERVER_RECODE_PROOF = "Recode Proof Bad";
LOGIN_BANNED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been closed and is no longer available for use.  Please go to <a href=\"http://www.wow-mania.com/forums/topic/2372\">http://www.wow-mania.com/forums/topic/2372</a> for further information.</p></body></html>";
LOGIN_CHARGEBACK = "<html><body><p align=\"CENTER\">This World of Warcraft account has been temporary closed due to a chargeback on its subscription.  Please refer to this <a href=\"http://www.wow-mania.com/forums\">http://www.wow-mania.com/forums</a> for further information.</p></body></html>";
LOGIN_CONVERSION_REQUIRED = "<html><body><p align=\"CENTER\">You must log in with a username and password. To create an account please <a href=\"http://www.wow-mania.com/forums\">Click Here</a>or go to:|n<a href=\"http://www.wow-mania.com/forums\">http://www.wow-mania.com/forums</a>|nto begin the conversion.</p></body></html>";
...
LOGIN_ERROR = "Error";
LOGIN_EXPIRED = "<html><body><p align=\"CENTER\">Your game account subscription has expired. Please visit <a href=\"http://www.wow-mania.com\">http://www.wow-mania.com</a> to purchase. more time.</p></body></html>";
LOGIN_FAILED = "<html><body><p align=\"CENTER\">Unable to connect. Please try again later. If the problem persists, please contact technical support at: <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a></p></body></html>";
LOGIN_GAME_ACCOUNT_LOCKED = "<html><body><p align=\"CENTER\">Access to your account has been temporarily disabled. Please contact support for more information at: <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a></p></body></html>";
LOGIN_IGR_WITHOUT_BNET = "<html><body><p align=\"CENTER\">In order to log in to World of Warcraft using IGR time, this World of Warcraft account must first be merged with a Battle.net account. Please visit <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18/</a> to merge this account.</p></body></html>";
...
LOGIN_MALFORMED_ACCOUNT_NAME = "<html><body><p align=\"CENTER\">The information you have entered is not valid.  Please check the spelling of the account name and password.  If you need help in retrieving a lost or stolen password and account, see <a href=\"http://www.wow-mania.com/forums/18\">www.wow-mania.com/forums/18</a> for more information.</p></body></html>";
LOGIN_NOTIME = "<html><body><p align=\"CENTER\">You have used up your prepaid time for this account. Please visit <a href=\"http://www.wow-mania.com/forums/18\">www.wow-mania.com/forums/18</a> to purchase more to continue playing.</p></body></html>";
LOGIN_NO_BATTLENET_APPLICATION = "<html><body><p align=\"CENTER\">There was an error logging in. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a></p></body></html>";
LOGIN_NO_BATTLENET_MANAGER = "<html><body><p align=\"CENTER\">There was an error logging in. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.wow-mania.com/forums/18\">http://www.wow-mania.com/forums/18</a></p></body></html>";
...
LOGIN_SUSPENDED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been temporarily suspended. Please go to <a href=\"http://www.wow-mania.com/forums/topic/2372\">http://www.wow-mania.com/forums/topic/2372</a> for further information.</p></body></html>";
LOGIN_TOO_FAST = "You have too many login attempts. Please try again in a few minutes.";
LOGIN_TRIAL_EXPIRED = "<html><body><p align=\"CENTER\">Your trial subscription has expired. Please visit <a href=\"http://www.wow-mania.com/forums/18\">www.wow-mania.com/forums/18\</a> to upgrade your account.</p></body></html>";
...
QUEUE_FCM_URL = "http://www.wow-mania.com/connect";
...
REALM_HELP_FRAME_URL = "<a href=\"http://www.wow-mania.com\">www.wow-mania.com</a>";
...
RESPONSE_FAILED_TO_CONNECT = "Failed to connect.  Please be sure that your computer is currently connected to the internet, and that no security features on your system might be blocking traffic.  See www.wow-mania.com for more information.";
...
SCANDLL_URL_HACK = "http://www.wow-mania.com/forums";
SCANDLL_URL_LAUNCHER_TXT = "http://www.wow-mania.com/forums";
SCANDLL_URL_TROJAN = "http://www.wow-mania.com/forums";
...
SERVER_ALERT_BETA_URL = "http://www.wow-mania.com/alert";
SERVER_ALERT_BUTTON_TEXT = "More Info";
SERVER_ALERT_PTR_URL = "";
SERVER_ALERT_TITLE = "WoW-Mania's Breaking News";
SERVER_ALERT_URL = "";
...
SYSTEM_INCOMPATIBLE_SSE = "<html><body><p align=\"CENTER\">This system will not be supported in future versions of World of Warcraft. Please see <a href=\"http://www.wow-mania.com/forums\">http://www.wow-mania.com/forums</a> for more information.</p></body></html>";
TECH_SUPPORT = "Tech Support";
TECH_SUPPORT_URL = "http://www.wow-mania.com/forums";
TEMP_ARMOR = "- Cloth\n- Leather\n- Mail";
