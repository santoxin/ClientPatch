...
ABILITY_INFO_GOBLIN1 = "- Can use rockets to jump high into the sky.";
ABILITY_INFO_GOBLIN2 = "- Can summon a Hobgoblin merchant.";
ABILITY_INFO_GOBLIN3 = "- Alchemy skill increased.";
ABILITY_INFO_GOBLIN4 = "- Engineering skill increased.";
ABILITY_INFO_FELORC1 = "- Can use Worg Form to travel faster and regenerate health.";
ABILITY_INFO_FELORC2 = "- Skinning skill increased.";
ABILITY_INFO_FELORC3 = "- Resistant to Nature damage.";
ABILITY_INFO_FELORC4 = "- Resistant to Shadow damage.";
...
ACCOUNT_CREATE_URL = "http://www.nostairius.org/register";
ACCOUNT_MESSAGE_BODY_NO_READ_URL = "http://ww.nostairius.org/support";
ACCOUNT_MESSAGE_BODY_URL = "http://ww.nostairius.org";
ACCOUNT_MESSAGE_BUTTON_READ = "Mark as read";
ACCOUNT_MESSAGE_HEADERS_URL = "http://ww.nostairius.org";
ACCOUNT_MESSAGE_READ_URL = "http://ww.nostairius.org";
...
AUTH_BANNED_URL = "http://www.nostairius.org/rules";
...
AUTH_DB_BUSY_URL = "http://ww.nostairius.org/status";
...
AUTH_NO_TIME_URL = "http://ww.nostairius.org/connect";
...
AUTH_PARENTAL_CONTROL_URL = "http://ww.nostairius.org";
...
AUTH_SUSPENDED_URL = "http://ww.nostairius.org/terms";
...
BLIZZ_DISCLAIMER = "Copyright 2016-2017  Nostairius Private Servers. All Rights Reserved.";
BLOCK = "BLOCK %.2f";
...
ENTER_EMAIL = "Enter your user name";
...
INT = "INT";
LATEST_AGREEMENTS_URL = "http://www.nostairius.org/rules";
LATEST_EULA_URL = "http://www.nostairius.org/terms";
LATEST_TERMINATION_WITHOUT_NOTICE_URL = "http://www.nostairius.org/rules";
LATEST_TOS_URL = "http://www.nostairius.org/rules";
...
LOGIN_AUTH_OUTAGE = "<html><body><p align=\"CENTER\">The login server is currently busy. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.nostairius.org/status\">http://www.nostairius.org/status</a></p></body></html>";
LOGIN_BADVERSION = "<html><body><p align=\"CENTER\">Unable to validate game version.  This may be caused by file corruption or the interference of another program.  Please visit <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a> for more information and possible solutions to this issue.</p></body></html>";
LOGIN_BAD_SERVER_PROOF = "<html><body><p align=\"CENTER\">You are connecting to an invalid game server. Please contact Technical Support for assistance at: <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a></p></body></html>";
LOGIN_BAD_SERVER_RECODE_PROOF = "Recode Proof Bad";
LOGIN_BANNED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been closed and is no longer available for use.  Please go to <a href=\"http://www.nostairius.org/forums/topic/2372\">http://www.nostairius.org/forums/topic/2372</a> for further information.</p></body></html>";
LOGIN_CHARGEBACK = "<html><body><p align=\"CENTER\">This World of Warcraft account has been temporary closed due to a chargeback on its subscription.  Please refer to this <a href=\"http://www.nostairius.org/forums\">http://www.nostairius.org/forums</a> for further information.</p></body></html>";
LOGIN_CONVERSION_REQUIRED = "<html><body><p align=\"CENTER\">You must log in with a username and password. To create an account please <a href=\"http://www.nostairius.org/forums\">Click Here</a>or go to:|n<a href=\"http://www.nostairius.org/forums\">http://www.nostairius.org/forums</a>|nto begin the conversion.</p></body></html>";
LOGIN_DBBUSY = "Could not log in to World of Warcraft at this time.  Please try again later.";
LOGIN_ENTER_NAME = "Please enter your user name.";
LOGIN_ENTER_PASSWORD = "Please enter your password.";
LOGIN_ERROR = "Error";
LOGIN_EXPIRED = "<html><body><p align=\"CENTER\">Your game account subscription has expired. Please visit <a href=\"http://www.nostairius.org\">http://www.nostairius.org</a> to purchase. more time.</p></body></html>";
LOGIN_FAILED = "<html><body><p align=\"CENTER\">Unable to connect. Please try again later. If the problem persists, please contact technical support at: <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a></p></body></html>";
LOGIN_GAME_ACCOUNT_LOCKED = "<html><body><p align=\"CENTER\">Access to your account has been temporarily disabled. Please contact support for more information at: <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a></p></body></html>";
LOGIN_IGR_WITHOUT_BNET = "<html><body><p align=\"CENTER\">In order to log in to World of Warcraft using IGR time, this World of Warcraft account must first be merged with a Battle.net account. Please visit <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18/</a> to merge this account.</p></body></html>";
...
LOGIN_MALFORMED_ACCOUNT_NAME = "<html><body><p align=\"CENTER\">The information you have entered is not valid.  Please check the spelling of the account name and password.  If you need help in retrieving a lost or stolen password and account, see <a href=\"http://www.nostairius.org/forums/18\">www.nostairius.org/forums/18</a> for more information.</p></body></html>";
LOGIN_NOTIME = "<html><body><p align=\"CENTER\">You have used up your prepaid time for this account. Please visit <a href=\"http://www.nostairius.org/forums/18\">www.nostairius.org/forums/18</a> to purchase more to continue playing.</p></body></html>";
LOGIN_NO_BATTLENET_APPLICATION = "<html><body><p align=\"CENTER\">There was an error logging in. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a></p></body></html>";
LOGIN_NO_BATTLENET_MANAGER = "<html><body><p align=\"CENTER\">There was an error logging in. Please try again later. If the problem persists, please contact Technical Support at: <a href=\"http://www.nostairius.org/forums/18\">http://www.nostairius.org/forums/18</a></p></body></html>";
...
LOGIN_SUSPENDED = "<html><body><p align=\"CENTER\">This World of Warcraft account has been temporarily suspended. Please go to <a href=\"http://www.nostairius.org/forums/topic/2372\">http://www.nostairius.org/forums/topic/2372</a> for further information.</p></body></html>";
LOGIN_TOO_FAST = "You have too many login attempts. Please try again in a few minutes.";
LOGIN_TRIAL_EXPIRED = "<html><body><p align=\"CENTER\">Your trial subscription has expired. Please visit <a href=\"http://www.nostairius.org/forums/18\">www.nostairius.org/forums/18\</a> to upgrade your account.</p></body></html>";
...
QUEUE_FCM_URL = "http://www.nostairius.org/connect";
...
RACE_INFO_FELORC = "Behind the formidable Greymane Wall, a terrible curse has spread throughout the isolated human nation of Gilneas, transforming many of its stalwart citizens into nightmarish beasts known as Worgen. The origins of this curse have been fiercely debated, but only recently has the startling truth come to light.";
RACE_INFO_FELORC_FEMALE = "Behind the formidable Greymane Wall, a terrible curse has spread throughout the isolated human nation of Gilneas, transforming many of its stalwart citizens into nightmarish beasts known as Worgen. The origins of this curse have been fiercely debated, but only recently has the startling truth come to light.";
...
REALM_HELP_FRAME_URL = "<a href=\"http://www.nostairius.org\">www.nostairius.org</a>";
...
REGEN = "REGEN %.0f";
RELEASE_BUILD = "Nostairius WotLK 1.0.0";
...
RESPONSE_FAILED_TO_CONNECT = "Failed to connect.  Please be sure that your computer is currently connected to the internet, and that no security features on your system might be blocking traffic.  See www.nostairius.org for more information.";
...
SAVE_ACCOUNT_NAME = "Remember User Name";
...
SCANDLL_URL_HACK = "http://www.nostairius.org/forums";
SCANDLL_URL_LAUNCHER_TXT = "http://www.nostairius.org/forums";
SCANDLL_URL_TROJAN = "http://www.nostairius.org/forums";
...
SELECT_CHARACTER = "Select A Hero";
SELECT_RACE = "Select your race";
SERVER_ALERT_BETA_URL = "http://www.nostairius.org/alert";
SERVER_ALERT_BUTTON_TEXT = "More Info";
SERVER_ALERT_PTR_URL = "";
SERVER_ALERT_TITLE = "Nostairius's Breaking News";
SERVER_ALERT_URL = "";
...
SYSTEM_INCOMPATIBLE_SSE = "<html><body><p align=\"CENTER\">This system will not be supported in future versions of World of Warcraft. Please see <a href=\"http://www.nostairius.org/forums\">http://www.nostairius.org/forums</a> for more information.</p></body></html>";
TECH_SUPPORT = "Tech Support";
TECH_SUPPORT_URL = "http://www.nostairius.org/forums";
TEMP_ARMOR = "- Cloth\n- Leather\n- Mail";
