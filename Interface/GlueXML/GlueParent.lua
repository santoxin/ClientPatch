...
GlueAmbienceTracks["DARKPORTAL"] = "GlueScreenIntro- Original";
GlueAmbienceTracks["DEATHKNIGHT"] = "GlueScreenDeathKnight";
GlueAmbienceTracks["CHARACTERSELECT"] = "GlueScreenIntro- Original";
GlueAmbienceTracks["GOBLIN"] = "GlueScreenOrcTroll";
GlueAmbienceTracks["FELORC"] = "GlueScreenNightElf";
